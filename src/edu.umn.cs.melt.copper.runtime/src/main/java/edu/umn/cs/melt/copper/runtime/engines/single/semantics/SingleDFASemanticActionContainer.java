...
public abstract class SingleDFASemanticActionContainer<EXCEPT extends Exception> implements SemanticActionContainer<SingleDFAMatchData,EXCEPT>
{
	 ...
	 * @throws EXCEPT When the code requires.
	 */
	public abstract Object runSemanticAction(InputPosition _pos,SingleDFAMatchData _terminal)
	throws IOException,EXCEPT;
	 ...
	 * @throws EXCEPT When the code requires.
	 */
	public abstract int runDisambiguationAction(InputPosition _pos,SingleDFAMatchData matches)
	throws IOException,EXCEPT;
}
