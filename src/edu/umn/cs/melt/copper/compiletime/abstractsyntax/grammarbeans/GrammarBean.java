 ...
 *
 */
public class GrammarBean extends CopperASTBean
{
	/** The elements of the grammar. */
	protected Hashtable<CopperElementName,GrammarElementBean> grammarElements;
	...
	protected GrammarBean(CopperElementType type)
	{
		super(type);
		grammarElements = new Hashtable<CopperElementName,GrammarElementBean>();
		grammarLayout = null;
	...
	/**
	 * @see GrammarBean#grammarElements
	 */
	public GrammarElementBean getGrammarElement(CopperElementName element)
	{
	 ...
	 */
	public boolean addGrammarElement(GrammarElementBean element)
