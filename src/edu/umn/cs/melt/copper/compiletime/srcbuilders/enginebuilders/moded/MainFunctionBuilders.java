...
{
	public static String buildModedParserMainFunction(String packageDecl,
            String parserName,
            String rootType,
            String errorType,
            ...
            String runtimeQuietLevel)
	{
		...
		ancillaries += "            	}\n";
		ancillaries += "        	}\n";
		ancillaries += "            " + ModedEngine.class.getName() + "<" + rootType + "," + errorType + "> engine = new " + ((packageDecl == null || packageDecl.equals("")) ? "" : (packageDecl + ".")) + parserName + "();\n";
	...
	public static String buildModedParserAncillaries(String packageDecl,
            										 String parserName,
            										 boolean gatherStatistics,
            										 boolean isPretty,
            										 String runtimeQuietLevel)
