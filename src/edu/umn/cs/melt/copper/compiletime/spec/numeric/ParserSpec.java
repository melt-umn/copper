...
public class ParserSpec
{
	...
	public final class TerminalData
	{
		...
		public final Regex getRegex(int t) { return regexes[t]; }
		...
		public final void setRegex(int t,Regex regex) { regexes[t] = regex; }
	...
	public final class ProductionData
	{
		...
		/** Each production's precedence class (note that this is distinct from the precedence of its operator -- see {@link Production#precedenceClass()}. */
